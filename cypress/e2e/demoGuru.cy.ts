...
describe('demo guru spec', () => {
  ...
  describe('login with valid credentials', () => {
    ...
    beforeEach('verify user is able to login with valid credentials', () => {
    ...
    it('verify request quotation with valid inputs data', () => {
      ...
      requestQuotation.selectParkingLocation(REQUEST_QUOTATION.PARKING_LOCATION)
    ...
    it('verify user is able to view the updated profile information', () => {
      ...
      profilePage.showPostcode().should('have.text', USER_PROFILE_INFO.POSTCODE)
  ...
  describe('login with invalid credentials', () => {
    ...
    it('verify error message when user logins with email only', () => {
      cy.login(INVALID_USER.EMAIL)
      commonPage
        .loggedInForm()
        .find('span')
        .should('have.text', MISSING_EMAIL_PASSWORD_ERROR)
    ...
    it('verify error message when user logins with password only', () => {
      cy.login(INVALID_USER.PASSWORD)
      commonPage
        .loggedInForm()
        .find('span')
        .should('have.text', MISSING_EMAIL_PASSWORD_ERROR)
